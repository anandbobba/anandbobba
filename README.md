...
- **UWB-based NLOS SLAM System** - Implementing Ultra-Wideband positioning for Non-Line-of-Sight environments
- **Visual SLAM** - Developing simultaneous localization and mapping using camera-based perception
- **Pressure Sensor Gait Analysis** - Building a system to analyze walking patterns using pressure sensors for biomechanics research

🧑‍🤝‍🧑 **Looking to Collaborate On:**
- Robotic-based college exhibitions and hackathons
- Innovative swarm robotics and multi-agent systems
- AI/ML integration with hardware projects
- Open-source robotics frameworks and tools

🤝 **Seeking Help With:**
- Machine Learning model optimization and deployment
- ROS (Robot Operating System) and advanced robot software architecture
- Backend development with blockchain integration
- Forming teams for hackathons with technically strong robotics enthusiasts

🌱 **Currently Learning:**
- **ROS Framework Deep Dive** - Mastering advanced ROS concepts, navigation stack, and MoveIt
- Advanced Machine Learning & Deep Learning
- SLAM Algorithms (Visual SLAM, UWB-based positioning)
- Computer Vision & Image Processing
- Blockchain Development & Smart Contracts
- Embedded Systems & IoT Integration

💬 **Ask Me About:**
- ROS (Robot Operating System) and industrial manipulator control
- Visual SLAM and UWB-based localization systems
- Computer vision model development and deployment
- Gait analysis and biomechanics with pressure sensors
- Building browser extensions and AI-powered tools
- Rescue robotics and autonomous navigation
- Hackathon strategies and rapid prototyping
- Arduino, Raspberry Pi, and embedded systems

⚡ **Fun Fact:**
I'm building robots that can navigate disaster zones, analyze your walking pattern, and even help you write—all while diving deep into the ROS rabbit hole!
